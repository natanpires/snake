...
public class SnakeGame extends JFrame {
	...
	private JTextField editTextField = new JTextField("Escreva algo ou sua chave secreta.");
	...
	private SnakeGame() {
		...
		editTextField.setFont(new Font("Tahoma", Font.BOLD, 12));
		editTextField.setForeground(Color.white);
		editTextField.setBackground(Color.black);
		editTextField.addAncestorListener(new Focus(false));
		this.side.add(editTextField);
		...
		this.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
                ...
                case KeyEvent.VK_T:
                    if (e.isControlDown()) {
						try {
							...
							rsa.encrypt(editTextField.getText(), pair.getPublic());
						} catch (Exception ex) {
							ex.printStackTrace();
						}
					}
				...
				/*
				 * Se o jogo não estiver pausado e não terminou...
				 * 
				 * Valida se a lista de direções não está cheia, e se
				 * a posição mais recente é para cima.
				 */
                 ...
                 *
                 * Valida se a lista de direções não está cheia, e se
                 * a posição mais recente é para baixo.
                 */
				case KeyEvent.VK_S:
                 ...
                 *
                 * Valida se a lista de direções não está cheia, e se
                 * a posição mais recente é para esquerda.
                 */
				case KeyEvent.VK_A:
                 ...
                 *
                 * Valida se a lista de direções não está cheia, e se
                 * a posição mais recente é para direita.
                 */
				case KeyEvent.VK_D:
				...
				/*
				 * Se o jogo não estiver terminado, pausa o mesmo.
				 */
				case KeyEvent.VK_P:
					if(!isGameOver) {
						isPaused = !isPaused;
				...
				/*
				 * Reseta o jogo, caso não esteja jogando.
				 */
		...
		/*
		 * Ajusta o tamanho da tela e centraliza.
		 */
		pack();
	...
	private void startGame() {
		...
		/*
		 * Loop do jogo que vai renderizar.
		 */
		while(true) {
	...
	/**
	 * Reseta o jogo para os padrões iniciais.
	 */
